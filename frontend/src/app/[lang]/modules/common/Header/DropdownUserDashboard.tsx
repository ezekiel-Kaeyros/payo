...
const DropdownUserDashboard = ({ dict }: { dict: string }) => {
  ...
  return (
    <div className="relative" style={{
      ...
      >
        <CommonHeaderElement dict={dict} specialStyle={"xl:hidden"} />
      </div>
      {/* <!-- Dropdown End --> */}
    </div>
  );
...
export default DropdownUserDashboard;
        ...
        //   <li>
        //     <Link href="/decaissement" className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
        //     {/* className="md:flex md:gap-x-[5px] md:border-easeBlue md:border-[2px] md:p-[.5rem] md:pl-[2rem] md:pr-[2rem] md:rounded-xl md:bg-transparent md:text-easeBlue    border-easeBlue border-[2px] p-[.5rem] pl-[2rem] pr-[2rem] rounded-xl bg-transparent" */}
        //     <svg
        //         className="fill-current"
        //         width="22"
        //         height="22"
        ...
        //     </Link>
        //   </li>
        //   <li className="xl:hidden flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
