...
const Header = (props: {
  ...
  return (
    <header className={`sticky right-0 justify-self-end top-0 z-[100] ${ props.marginStyle } ${ props.borderRadius } flex w-${ props.headerSizeStyle }  bg-easeBlue drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none`}>
      <div className="flex flex-grow items-center justify-between p-[24px] shadow-2 md:px-6 2xl:px-11">
      {/* px-4 py-4 */}
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          {/* <button
            ...
            className="z-99999 block rounded-sm border border-stroke bg-easeBlue p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden"
          >
          ...
          <Link className="block flex-shrink-0" href={ `/${ programId[1]}` }>
            <Image
              width={100}
              height={100}
              src={ logoI }
        ...
        <div className={`flex ${ props.imageDisplay ? "" : "justify-between w-full" } items-center gap-3 2xsm:gap-7`}>
          <ul className="flex items-center gap-2 2xsm:gap-4">
            <Link href={`/${ programId[1]}/decaissement`} className="hidden sm:block md:flex md:gap-x-[5px] md:border-white md:border-[2px] md:p-[.5rem] md:pl-[2rem] md:pr-[2rem] md:rounded-xl md:bg-transparent md:text-white    border-white border-[2px] p-[.5rem] pl-[2rem] pr-[2rem] rounded-xl bg-transparent">
