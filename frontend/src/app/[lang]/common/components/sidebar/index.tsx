...
import dashboarImg from '../../../../../../public/sidebarIcons/chart.svg'; 
import decaissementImg from '../../../../../../public/sidebarIcons/note.svg'; 
import userImg from '../../../../../../public/sidebarIcons/user.svg'; 
import settingImg from '../../../../../../public/sidebarIcons/setting.svg'; 
...
const MainSidebar = ({ dict, sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const [ userInfoOnNavBar, setUserInfoOnNavBar ] = useState<{first_name: string; last_name: string, role: Array<{ name: string, level: number }> }> ()
  ...
  return (
    <aside
      ...
      style={{
        zIndex: 2147483647,
        display: `${ storeData ? "flex" : "" }`,
      }}
      className={` fixed ${ storeData ? "flex" : "hidden" } left-0 top-0 z-2147483647 w-[300px] lg:flex h-screen lg:w-72.5 flex-col overflow-y-hidden bg-easeBlue duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
        storeData ? "translate-x-0 hidden" : "-translate-x-full flex"
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      ...
      <Link className="pl-[3rem] block flex-shrink-0" href={`/${ programId[1]}`}>
        <Image
          width={150}
          height={150}
          src={ logoI }
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === `/${ programId[1]}` || pathname.includes("dashboard")
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <li>
                ...
                >
                  ...
                  >
                   ...
                   <Image src={ dashboarImg } width={20} height={20} alt='Office' />
                   { dict?.page?.dashboard?.sideBar?.DSBD }
                  {/* Tableau de Bord */}
                </Link>
              </li>
              {/* <!-- Menu Item Calendar --> */}
              ...
              <li>
                <Link
                  href={`/${ programId[1]}/decaissements`}
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("decaissements") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  {/* <svg
                    className="fill-current"
                  ...
                  <Image src={ decaissementImg } width={20} height={20} alt='decaissement' />
                  {/* Décaissements */}
                  { dict?.page?.dashboard?.sideBar?.decaissement }
                </Link>
              </li>
              {/* <!-- Menu Item Profile --> */}
              ...
              {
                userInfoOnNavBar?.role[0]?.level === 1 ? 
                <li>
                  <Link
                    href={`/${ programId[1]}/users`}
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                  ...
                  >
                    ...
                    <Image src={ userImg } width={20} height={20} alt='decaissement' />
                    {/* Utilisateurs */}
                    { dict?.page?.dashboard?.sideBar?.configU }
                  </Link>
                </li>
                :
                ""
                ...
                userInfoOnNavBar?.role[0]?.level === 1 ? 
                  <li>
                    ...
                    >
                      ...
                      <Image src={ settingImg } width={20} height={20} alt='decaissement' />
                      {/* Paramètres */}
